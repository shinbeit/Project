		...
		<div class="row">
			<div style="margin: 0 auto;" align="center">
				<div class="col-md-6 col-lg-7 px-lg-5 py-md-5 bg-white" style="width: 1000px; float: left">
					<form action="" class="p-5 bg-white" name="myCompanyForm" method="post">
						<div class="Layer" align="center">
							<a class="navbar-brand">
							<font color="black">Partycket&nbsp;&nbsp;&nbsp;Login</font></a>
							<br /><br />
							<p>
								<a href="<%=cp%>/userLogin.action " class="btn btn-secondary py-2 px-4" style="width: 190px;">
								<font color="white">일반회원 로그인</font></a> 
								<a href="<%=cp%>/companyLogin.action" class="btn btn-dark py-2 px-4" style="width: 190px;"
						...
						<div class="form-group" align="left">
							<label for="name" style="font-weight: normal;" class=""><font
								color="#232931">기업 아이디 *</font></label> <input type="text"
						...
						<div class="form-group" style="width: 500px;" align="left">
							<input type="button" value="로그인"
								class="btn py-3 px-4 btn-dark" onclick="companyLogin();"
